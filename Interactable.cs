...
public class Interactable : MonoBehaviour
{
    ...
    private void PerformAction(PlayerHealth playerHealth)
    {
        if (itemType == ItemType.Healing)
        {
            ...
            // Notificar ManualInteractionSystem que o objeto foi usado/destruído
            ManualInteractionSystem manualSystem = GetComponent<ManualInteractionSystem>();
            if (manualSystem != null)
            {
                manualSystem.OnObjectPickedUp(); // Desativar ícone antes de destruir
            }
    ...
    public void Drop()
    {
        ...
        // Notificar ManualInteractionSystem que foi largado
        ManualInteractionSystem manualSystem = GetComponent<ManualInteractionSystem>();
        if (manualSystem != null)
        {
